...
class Stock extends CI_Controller {
	...
	public function stock_exp_rem(){
		$data= $this->Stock_model->stock_exp_rem();
...
//                print_r($data['invoice_item']); print '<br>';
	...
	public function editstock($id){
		$data['title'] = 'Edit stock :: A2Z ';
		
        $data['item'] = $this->Purchase_model->get_all_data_grn($id);
		//echo '<pre>';print_r($data['item']);exit();
		$this->load->view('purchase_view',$data);
	}	
	public function cancel_grn($id){
			$data = $this->Purchase_model->cancel_grn($id);
			echo json_encode($data);
	}	
