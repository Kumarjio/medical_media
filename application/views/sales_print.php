                                    ...
                                    <table class="table-bordered">
                                      <thead>
                                        ...
                                        <tr style="font-size: 10px;">
                                          <td colspan="13" style="height: 70px;"><span style="padding: 5px"><img src="<?php echo base_url() ?>logo/logo.jpg" width="70" height="70"></span><span style="text-align: center;font-style: italic;font-size: 30px;padding-left: 80px;font-weight: bold;">A2Z Enterprises</span></td>
                                        ...
                                        <tr style="font-size: 10px;">
                                          ...
                                          <td colspan="3"><p><?php echo $print_det[0]['bill_no'] ?></p></td>
                                      ...
                                      <tbody >
                                       ...
                                       <tr style="font-size: 8px;text-align: center;height: 50px;">
                                        ...
                                        <?php } ?>
                                       <?php if(count($print_item) > 24){ $rows = 38-count($print_item); if($rows > 0){ for($i=0;$i<$rows;$i++){?>
                                       ...
                                       <?php }}}else if(count($print_item) > 10){ $rows = 24-count($print_item); if($rows > 0){ for($i=0;$i<$rows;$i++){?>
                                       <tr style="height: 50px;">
                                          <td></td>
                                          <td ></td>
                                          <td></td>
