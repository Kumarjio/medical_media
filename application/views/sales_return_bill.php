...
<body>
   ...
   */
$no = round($print_det[0]['return_gtotal'],0, PHP_ROUND_HALF_UP);
       $point = round($print_det[0]['return_gtotal'] - $no, 0, PHP_ROUND_HALF_UP) * 100;
       $hundred = null;
       $digits_1 = strlen($no);
       $i = 0;
       $str = array();
                            ...
                            <div class="panel panel-default">
                              <div class="panel-body">
                                    ...
                                    <table class="table-bordered">
                                      <thead>
                                        <tr>
                                          <td colspan="16" style="text-align: center;font-family: 'Eras ITC', 'Eras Bold ITC';font-style: italic;">Sales Return</td>
                                        </tr>
                                        ...
                                        <tr style="font-size: 10px;">
                                          <td colspan="4" rowspan="4"><span ><p style="margin-left: 20px;"><?php echo $print_det[0]['customer_name'] ?></span><br><span ><p style="margin-left: 20px;"><?php echo $print_det[0]['cus_address'] ?></span></p></td>
                                          <td colspan="2" rowspan="4"></td>
                                          <td colspan="3"><p>Invoice No</p></td>
                                          <td colspan="3"><p><?php echo $print_det[0]['sales_return_bill_no'] ?></p></td>
                                          <td colspan="2"><p>Date</p></td>
                                          <td colspan="2"><p><?php echo date('d-M-Y',strtotime($print_det[0]['return_date'])); ?></p></td>
                                        </tr>
                                        <tr style="font-size: 10px;">
                                          <td colspan="3"><p>Customer GST.No</p></td>
                                          <td colspan="3"><?php echo $print_det[0]['cus_gst_no'] ?></td>
                                          <td colspan="2"><p>D.L No 1</p></td>
                                          <td colspan="2"><p><?php echo $print_det[0]['cus_drug_lisence1'] ?></p></td>
                                        </tr>
                                        <tr style="font-size: 10px;">
                                          <td colspan="3">Dr.Registration No</td>
                                          <td colspan="3"><?php echo $print_det[0]['cus_dr_reg_no'] ?></td>
                                          <td colspan="2"><p>D.L No 2</p></td>
                                          <td colspan="2"><p><?php echo $print_det[0]['cus_drug_lisence2'] ?></p></td>
                                        </tr>
                                        <tr style="font-size: 10px;">
                                          <td colspan="3">Reg ID</td>
                                          <td colspan="3"><?php echo $print_det[0]['cus_reg_id'] ?></td>
                                          <td colspan="2"><p></p></td>
                                          <td colspan="2"><p></p></td>
                                        </tr>
                                      ...
                                      <tbody >
                                       ...
                                       <tr style="font-size: 8px;text-align: center;height: 50px;">
                                          ...
                                          <td width="7%"><p style="text-align: center;"><?php echo $value['return_qty'] ?></p></td>
                                          <td width="5%"><p style="text-align: center;">0</p></td>
                                          <td width="3%"><p style="text-align: center;"><?php echo $value['location_name'] ?></p></td>
                                          <td width="3%"><p style="text-align: center;"><?php echo $value['return_purrate'] ?></p></td>
                                          <td width="3%"><p style="text-align: center;">0%</p> </td>
                                          <td width="2%"><p style="text-align: center;"><?php echo $value['return_sgst'] ?>%</p></td>
                                          <td width="2%"><p style="text-align: center;"><?php echo $value['return_cgst'] ?>%</p></td>
                                          <td width="2%"><p style="text-align: center;"><?php echo $value['return_igst'] ?>%</p></td>
                                          <td width="10%"><p style="text-align: center;"><?php echo number_format($value['return_total'],2) ?></p></td>
                                        </tr>
                                        <?php } ?>
                                           <?php if(count($print_item) > 23){ $rows = 37-count($print_item); if($rows > 0){ for($i=0;$i<$rows;$i++){?>
                                       ...
                                       <?php }}}else if(count($print_item) > 11){ $rows = 23-count($print_item); if($rows > 0){ for($i=0;$i<$rows;$i++){?>
                                       <tr style="height: 50px;">
                                          <td></td>
                                          <td ></td>
                                          <td></td>
                                       ...
                                       <?php }}}else{
                                        $rows = 10-count($print_item); if($rows > 0){ for($i=0;$i<$rows;$i++){?>
                                    ...
                                    <?php
                                        ...
                                        ?>
                                        <tr>
                                          <th colspan="11" rowspan="6" ><p style="padding-left: 20px;">E & O.E</p></th>
                                          <th colspan="4"><p style="text-align: right;">Grass Value</p></th>
                                          <th colspan="1" ><p style="text-align: right;"><?php echo number_format($print_det[0]['return_stotal'],2); ?></p></th>
                                        </tr>
                                        <tr>
                                          <th colspan="4"><p style="text-align: right;">Discount Value</p></th>
                                          <th colspan="1" ><p style="text-align: right;"><?php echo number_format(0,2); ?></p></th>
                                        </tr>
                                        <tr>
                                          <th colspan="4"><p style="text-align: right;">CGST Value</p></th>
                                        ...
                                        <tr>
                                          <th colspan="4"><p style="text-align: right;">IGST Value</p></th>
                                          <th colspan="1" ><p style="text-align: right;"><?php echo number_format($igst,2); ?></p></th>
                                        </tr>
                                        <tr>
                                          <th colspan="4"><p style="text-align: right;">Net Value</p></th>
                                          <th colspan="1" ><p style="text-align: right;"><?php echo number_format(round($print_det[0]['return_gtotal'],0, PHP_ROUND_HALF_UP),2) ?></p></th>
                                        </tr>

                                        <tr>
                                          <th colspan="2"><p style="padding-left: 20px;"> Amount In Words</p></th>
                                          <th colspan="14"><p style="padding-left: 20px;"><?php echo $ret1.' Only/-'; ?></p></th>
                                        </tr>
                                      </tbody>
                                      <tfoot>
                                        ...
                                        <tr>
                                          <!-- <th colspan="16" style="height: 100px;">
                                            <span><p style="text-align: right;font-family: 'Eras ITC', 'Eras Bold ITC';font-style: italic;padding-right: 20px;">Fro A2z Enterprises<p></span><br>
                                            <span><img style="margin-right: 20px;" align="right" src="<?php echo base_url() ?>logo/logo.jpg" width="70" height="70"></span><br><br><br><br><br>
