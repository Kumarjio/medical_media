...
<div class="col-md-6">
     <div class="form-group">
        ...
        <div class="col-md-8">
           <input type="text" readonly class="form-control" value="<?php echo $item[0]['vendor_name'] ?>">                                       
        </div>
    </div>
     <!-- <div class="form-group">                                        
...
<div class="col-md-6">
     ...
     <div class="form-group">                                        
        ...
        <div class="col-md-8">
            <input type="text" class="form-control datepicker "  required placeholder="Enter PO Date" name="podate" id="podate" value="<?php echo $item[0]['podate'] ?>" readonly >
            <div class="error" ><?php echo form_error('pdate'); ?></div>                                               
        </div>
    </div>
    ...
    <div class="form-group">                                        
        ...
        <div class="col-md-8">
            <input type="text"   class="form-control  " required placeholder="Enter Invoice No"  name="vinvno" id="vinvno" value="<?php echo $item[0]['vinvno'] ?>" readonly>
  ...
  <div class="form-group">
        ...
        <div class="col-md-8">
         <input type="text"   class="form-control  " required placeholder="Enter Invoice No"  name="vinvno" id="vinvno" value="<?php echo $item[0]['storage_name'] ?>" readonly>                                 
        </div>
    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table" id="mytable">
                                            <thead>
                                                ...
                                                <tr>
                                                    <th width="10%">PO.NO<sup  style="color:#f00"> * </sup></th>
                                        ...
                                        <?php foreach ($item as $key) { ?>
                                            ...
                                            <tr>
                                                    <th width="7%"><?php echo $key['po_no']; ?></th>
                                                    <th width="10%"><?php echo $key['i_name'];echo "-"; echo $key['hsn_code'];  ?></th>
                                                    <th width="7%"><?php echo $key['batch_no']; ?></th>
                                                    <th width="7%"><?php echo $key['manu_name']; ?></th>
                                                    <th width="7%"><?php echo $key['expiry_date']; ?></th>
                                                    <th width="7%"><?php echo $key['location_name']; ?></th>
                                                    <th width="10%"><?php echo $key['qty']; ?></th>
                                                    <th width="7%"><?php echo $key['p_rate']; ?></th>
                                                    <th width="7%"><?php echo $key['p_amount']; ?></th>
                                                    <th width="8%"><?php echo $key['sgst']; ?>%</th>
                                                    <th width="8%"><?php echo $key['cgst']; ?>%</th>
                                                    <th width="8%"><?php echo $key['igst']; ?>%</th>
                                                  <!--   <th width="8%">Free<sup  style="color:#f00"> * </sup></th> --> 
                                                    <th width="4%"><?php echo $key['discount']; ?>%</th>
                                                    <th width="4%"><?php echo $key['include_item']; ?></th>
                                                   <th width="4%"><?php echo $key['free_pro']; ?></th>
                                                    
                                                   
                                                    <th width="10%"><?php echo $key['total']; ?></th>
                                                </tr>
                                                 <?php } ?> 
                                            </tbody>
                                        </table><br>
...
<br>
    ...
    <thead>
        ...
        <tr>
            ...
            <td style="font-weight:bold;" ><input type="text" class="form-control" name="stotal" style="color:#000" value="<?php echo number_format($item[0]['stotal'],2) ?>" readonly id="stotal"></td>
        </tr>
       
        <tr>
            <td colspan="9" width="75%"><button type="button" style="visibility:hidden;" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal" id="opener" ></button></td>
            <td style="font-weight:bold;" width="12%">Grand Total</td>
            <td style="font-weight:bold;" ><input type="text" class="form-control" readonly name="gtotal" style="color:#000" value="<?php echo number_format($item[0]['gtotal'],2) ?>" id="gtotal"></td>
        </tr>
