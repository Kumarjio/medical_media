     ...
     <!-- PAGE TITLE -->
                ...
                <div class="row">
                        ...
                        <div class="panel panel-default">
                            ...
                            <form class="form-horizontal" id="jvalidate" role="form" action="<?php echo base_url('index.php/Storage/savehsn');?>" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                           ...
                                           <div class="form-group">                                        
                                                ...
                                                <div class="col-md-8">
                                                	<input type="text" class="form-control "  name="hsn_code"  placeholder="Enter HSN Code" id="hsn_code" required>                                              
                                                </div>
                                            </div>
                                            	<div class="form-group">                                        
                                                <label class="col-md-4 control-label">Tax %<sup  style="color:#f00"> * </sup></label>
                                                <div class="col-md-8">
                                                 <input type="text" class="form-control "  name="tax"  placeholder="Enter TAx %" required id="tax" >                                               
                                                </div>
                                            </div>										
