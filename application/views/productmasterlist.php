...
<!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Manage Product Type Master</h2>
                </div>
                <!-- END PAGE TITLE -->                
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                              ...
                              <?php /*?>  <?php if($session_data['user_type']=='1'){?>
                                                    ...
                                                    <a href="<?php echo base_url('index.php/Protype/addprodcuttype1'); ?>"><button class="btn btn-primary"><span class="fa fa-plus"></span>Add Product Type</button></a>
                                                   <?php /*?> <?php }?>       <?php */?>                         
