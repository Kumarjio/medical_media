...
<body>
   ...
   */
$no = round($order[0]['po_gtotal'],0, PHP_ROUND_HALF_EVEN);
       $point = round($order[0]['po_gtotal'] - $no, 0, PHP_ROUND_HALF_EVEN) * 100;
       $hundred = null;
       $digits_1 = strlen($no);
       $i = 0;
       $str = array();
                            ...
                            <div class="panel panel-default">
                              <div class="panel-body">
                                    ...
                                    <table class="table">
                                      <thead>
                                        <tr>
                                          <td colspan="16" style="text-align: center;font-family: 'Eras ITC', 'Eras Bold ITC';font-size: 10px;">Purchase Order </td>
                                        </tr>
                                        ...
                                        <tr style="font-size: 10px;">
                                          <td colspan="4" rowspan="4"><span ><p style="margin-left: 20px;"><?php echo $order[0]['vendor_name'] ?></span><br><span ><p style="margin-left: 20px;"><?php echo $order[0]['address'] ?></span></p></td>
                                          <td colspan="3" rowspan="4"></td>
                                          <td colspan="3"><p>PO No</p></td>
                                          <td colspan="2"><p><?php echo $order[0]['po_no'] ?></p></td>
                                          <td colspan="2"><p>Date</p></td>
                                          <td colspan="2"><p><?php echo date('d-M-Y',strtotime($order[0]['po_date'])); ?></p></td>
                                        </tr>
                                        <tr style="font-size: 10px;">
                                        ...
                                        <tr style="font-size: 10px;">
                                          <td colspan="3"><p>Dr.Registration No</p></td>
                                      ...
                                      <tbody >
                                       <?php $sno=1;$discount_va=0; foreach ($order_item as $key => $value) { 
                                        $rate = $value['po_rate']/100;
                                        $tax_gst =  ($value['po_sgst']+$value['po_cgst']+$value['po_igst'])*$rate;
                                        $discount_va += $value['po_discount']*$rate;
                                        $mrp_rate = $value['po_rate']+$tax_gst;
                                        $overalltax = $value['po_qty']*$tax_gst; 
                                            ?>
                                       <tr style="font-size: 8px;text-align: center;height: 50px;">
                                          ...
                                          <td width="7%"><p style="text-align: center;"><?php echo $value['po_qty'] ?></p></td>
                                          ...
                                          <td width="3%"><p style="text-align: center;"><?php echo $value['po_rate'] ?></p></td>
                                          <td width="3%"><p style="text-align: center;"><?php echo $value['po_discount'] ?>%</p> </td>
                                          <td width="2%"><p style="text-align: center;"><?php echo $value['po_sgst'] ?>%</p></td>
                                          <td width="2%"><p style="text-align: center;"><?php echo $value['po_cgst'] ?>%</p></td>
                                          <td width="2%"><p style="text-align: center;"><?php echo $value['po_igst'] ?>%</p></td>
                                          <td width="10%"><p style="text-align: center;"><?php echo number_format($value['po_total'],2) ?></p></td>
                                        </tr>
                                        <?php } ?>
                                       <?php if(count($order_item) > 36){ $rows = 49-count($order_item); if($rows > 0){ for($i=0;$i<$rows;$i++){?>
                                       ...
                                       <?php }}}else if(count($order_item) > 23){ $rows = 36-count($order_item); if($rows > 0){ for($i=0;$i<$rows;$i++){?>
                                       <tr style="height: 50px;">
                                          <td></td>
                                          <td colspan="3"></td>
                                          <td></td>
                                       ...
                                       <?php }}}else if(count($order_item) > 10){ $rows = 23-count($order_item); if($rows > 0){ for($i=0;$i<$rows;$i++){?>
                                       <tr style="height: 50px;">
                                          <td></td>
                                          <td colspan="3"></td>
                                          <td></td>
                                       ...
                                       <?php }}}else{
                                        $rows = 10-count($order_item); if($rows > 0){ for($i=0;$i<$rows;$i++){?>
                                    ...
                                    <?php } } } 
                                        ...
                                        <tr>
                                          ...
                                          <th colspan="3"><p style="text-align: right;font-size: 10px;">Grass Value</p></th>
                                          <th colspan="1" ><p style="text-align: right;font-size: 10px;"><?php echo number_format($order[0]['po_stotal'],2) ?></p></th>
                                        </tr>
                                        <tr>
                                          <th colspan="3"><p style="text-align: right;font-size: 10px;">Discount Value</p></th>
                                          <th colspan="1" ><p style="text-align: right;font-size: 10px;"><?php echo number_format($discount_va,2) ?></p></th></tr>
                                          <tr>
                                          <th colspan="3"><p style="text-align: right;font-size: 10px;">SGST Value</p></th>
                                          <th colspan="1" ><p style="text-align: right;font-size: 10px;"><?php echo number_format($sgst,2) ?></p></th></tr>
                                          <tr>
                                          <th colspan="3"><p style="text-align: right;font-size: 10px;">CGST Value</p></th>
                                          <th colspan="1" ><p style="text-align: right;font-size: 10px;"><?php echo number_format($cgst,2) ?></p></th>
                                        </tr>
                                        <tr>
                                          <th colspan="3"><p style="text-align: right;font-size: 10px;">IGST Value</p></th>
                                          <th colspan="1" ><p style="text-align: right;font-size: 10px;"><?php echo number_format($igst,2) ?></p></th>
                                        </tr>
                                        <tr>
                                          <th colspan="3"><p style="text-align: right;font-size: 10px;">Net Value</p></th>
                                          <th colspan="1" ><p style="text-align: right;font-size: 10px;"><?php echo number_format(round($order[0]['po_gtotal'],0, PHP_ROUND_HALF_UP),2) ?></p></th>
                                        </tr>
                                        <tr>
