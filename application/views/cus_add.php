...
<body>
  <?php $this->load->view('menu_navigation'); ?>
          ...
          <div class="row">
            <div class="col-md-12">
             <form class="form-horizontal" id="jvalidate" role="form" action="<?php echo base_url('index.php/Customer/addCUS');?>" method="post">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">	
                            <div class="form-group">                                        
                               ...
                               <div class="col-md-6">
                               <input type="text" class="form-control "  name="customer_name"  placeholder="Enter Customer Name" required id="customer_name" value="<?php echo set_value('vendor_name');  ?>">
                        ...
                        <div class="col-md-6"> 
                         ...
                         <div class="col-md-6" style="margin-top: 20px;"> 
                            <div class="form-group">                                        
                               ...
                               <div class="col-md-8">
                               <input type="text" class="form-control "  name="c_period"  placeholder="Enter Credit period" value="" required id="c_period">
                               </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6"> 
                                ...
                                <div class="form-group">                                        
                                 ...
                                 <div class="form-group">                                        
                                    ...
                                    <div class="col-md-8">
                                    <label><input type="radio" name="tax_type" value="1" required>&nbsp;&nbsp;GST&nbsp;&nbsp;</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <label><input type="radio" name="tax_type" value="2" required>&nbsp;&nbsp;IGST&nbsp;&nbsp;</label>            
                                    </div>
                                </div>
                            </div>
                        </div>
