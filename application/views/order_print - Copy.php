...
<body>
   ...
   */
$no = round($order[0]['po_gtotal'],0, PHP_ROUND_HALF_UP);
       $point = round($order[0]['po_gtotal'] - $no, 0, PHP_ROUND_HALF_UP) * 100;
       $hundred = null;
       $digits_1 = strlen($no);
       $i = 0;
       $str = array();
                              ...
                              <div class="panel-body">
                                    ...
                                    <table class="">
                                      <thead>
                                        ...
                                        <tr>
                                          <th colspan="3" rowspan="4"><span style="margin-left: 20px;font-size: 9px;"><span><?php echo $order[0]['vendor_name'] ?></span><br>
                                          <span style="margin-left: 20px;font-size: 9px;text-align: "><?php echo $order[0]['address'] ?></span></th>
                                          <th colspan="3" rowspan="4"></th>
                                        </tr>
                                        <tr>
                                          <td colspan="2" style="font-size: 10px;text-align: center;">PO No:</td>
                                          <td colspan="2" style="font-size: 10px;text-align: center;"><?php echo $order[0]['po_no'] ?></td>
                                        ...
                                        <tr>
                                          ...
                                          <td colspan="2" style="font-size: 10px;text-align: center;"><?php echo $order[0]['po_date'] ?></td>
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                          ...
                                          <th style="width: 60px;text-align: center;">Mgf <br> Name</th>
                                          <th style="width: 80px;text-align: center;">MRP</th>
                                          <th style="width: 80px;text-align: center;">Qty</th>
                                          <th style="width: 40px;text-align: center;">Free Qty</th>
                                      ...
                                      <tbody>
                                        ...
                                        <?php $sno=1; foreach ($order_item as $key => $value) {
                                         ...
                                         <tr>
                                          ...
                                          <td style="width: 100px;font-size: 10px;text-align: center;"><?php echo $value['i_name'] ?></td>
                                          ...
                                          <td style="width: 40px;font-size: 9px;text-align: center;"><?php echo $value['po_qty'] ?></td>
                                          <td style="width: 40px;font-size: 10px;text-align: center;"><?php echo $value['po_free_qty'] ?></td>
                                          <td style="width: 50px;font-size: 10px;text-align: center;"><?php echo $value['location_name'] ?></td>
                                          <td style="width: 60px;font-size: 10px;text-align: center;"><?php echo $value['po_rate'] ?></td>
                                          <td style="width: 40px;font-size: 10px;text-align: center;"><?php echo $value['po_discount'] ?>%</td>
                                          <td style="width: 40px;font-size: 10px;text-align: center;"><?php echo $value['po_sgst'] ?>%</td>
                                          <td style="width: 40px;font-size: 10px;text-align: center;"><?php echo $value['po_cgst'] ?>%</td>
                                          <td style="width: 40px;font-size: 10px;text-align: center;"><?php echo $value['po_igst'] ?>%</td>
                                          <td style="width: 100px;font-size: 10px;text-align: center;"><?php echo number_format($value['po_total'],2) ?></td>
                                        </tr>
                                      ...
                                      <tfoot>
                                         <tr>
                                           ...
                                           <th colspan="1" style="padding: 5px;"><?php echo number_format(round($order[0]['po_gtotal'],0, PHP_ROUND_HALF_UP),2) ?></th>
                                         </tr>
                                         <tr>
