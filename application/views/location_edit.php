     ...
     <!-- PAGE TITLE -->
                ...
                <div class="row">
                        ...
                        <div class="panel panel-default">
                            ...
                            <form class="form-horizontal" id="ncourse" role="form" action="<?php echo base_url();?>index.php/Employee/location_update/<?php echo $unit[0]['id'] ?>"  method="post">
                            <div class="panel-body">                                                                        
                                   ...
                                   <label class="col-md-4 control-label">Unit<sup  style="color:#f00"> * </sup></label>
                                       <div class="col-md-8"> 
                                  <input type="text" required  class="form-control align-left" style="color:#000;" value="<?php echo $unit[0]['location_name'] ?>" name="location"  id="location"    >
