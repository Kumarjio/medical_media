                              ...
                              <div class="panel-body">
                                    <div class="table" id="print_panel">
                                      ...
                                      <?php /*?><tr>
                                         ...
                                         <tr style="border-style:solid;border:1;border-width=:1px;border-right-color: #ff0000;"  >
                                         ...
                                         <th colspan="8"><center><u>Subject :- Arrow18 LED LIGHTING INVOICE</u></center></th>
                                            ...
                                            <tr style="border-style:solid;border:1;border-width=:1px;"  >    <th width="112">S.No</th>
                                                ...
                                                <?php /*?> <tr>
                                                  ...
                                                  <tr style="border-style:solid;border:1;border-width=:1px;"  >
                                                   ...
                                                   <tr style="border-style:solid;border:1;border-width=:1px;"  >
                                                       ...
                                                       <td>&nbsp;</td>
                                                       <td>Round  Pay (+)</td>
                                                      <td><?=number_format($loop['total_value'],2)?></td>
                                                  </tr> 
                                                   <tr style="border-style:solid;border:1;border-width=:1px;"  >
                                                       <td>&nbsp;</td>
                                                       <td>&nbsp;</td>
                                                       ...
                                                       <td><strong><?=number_format(round($loop['total_value']),2)?></strong></td>
                                            ...
                                            <tr style="border-style:solid;border:1;border-width=:1px;"  >
                                              <td colspan="7"><strong>Rupees in words:</strong>-<?=$this->Sales_model->rupeestowords1(round($loop['total_value']))?></td>
                                            </tr>
                                            <tr style="border-style:solid;border:1;border-width=:1px;" >
                                           <td colspan="7"> <strong>For Arrow18,<br>
