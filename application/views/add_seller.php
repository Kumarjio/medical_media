                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">	
                            <div class="form-group">                                        
                               ...
                               <div class="col-md-6">
                               <input type="text" class="form-control "  name="vendor"  placeholder="Enter Vendor Name" required id="vendor" value="<?php echo set_value('vendor_name');  ?>">
                        ...
                        <div class="col-md-6" style="margin-top: 20px;"> 
                            <div class="form-group">                                        
                               ...
                               <div class="col-md-8">
                               <input type="text" class="form-control "  name="v_period"  placeholder="Enter Credit period" required id="v_period">
                               </div>
                            </div>
                        </div>
