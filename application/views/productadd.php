...
<div class="col-md-6">
    ...
    <div class="form-group">                                        
        ...
        <div class="col-md-6">
                <input type="text" class="form-control " required placeholder="Enter Product Description" pattern="^[a-zA-Z0-9-_\s./@]{2,}$"   name="product_name" id="product_name" />
        </div>
    </div>
<div class="form-group">                                        
 ...
 <div class="col-md-6">
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            <input type="text"  class="form-control " placeholder="Enter Manufacturer Name" name="m_name" id="m_name" value="<?php echo set_value('hsn');  ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            <input type="text"  class="form-control " placeholder="Enter Common Sales Rate" name="comm_rate" id="comm_rate" >
            <span class="help-block"></span>
