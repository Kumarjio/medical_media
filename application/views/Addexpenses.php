     ...
     <!-- PAGE TITLE -->
                ...
                <div class="row">
                        ...
                        <div class="panel panel-default">
                            ...
                            <form class="form-horizontal" id="jvalidate" role="form" action="<?php echo base_url('index.php/Expenses_master/addExpenses');?>" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">                                            
                                                    <input type="text" class="form-control uppercase" style="color:#000;" name="expenses_type" required placeholder="Enter Expenses Type" id="customer_type" value="">     
