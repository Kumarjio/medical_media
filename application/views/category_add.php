     ...
     <!-- PAGE TITLE -->
                ...
                <div class="row">
                        ...
                        <div class="panel panel-default">
                            ...
                            <form class="form-horizontal" id="jvalidate" role="form" action="<?php echo base_url('index.php/Product/category_add');?>" method="post">
...
<div class="col-md-6">
    ...
    <div class="form-group">                                        
        ...
        <div class="col-md-6">
                <input type="text" class="form-control " required placeholder="Enter Add Category"   name="c_name" id="c_name" />
