                                    ...
                                    <div class="table-responsive">
                                        <table class="table datatable">
											...
											<tr>
												...
												<th width="52">No Of Credit Days</th>
										...
										$qty = 0;
										 ...
										 if(is_array($stock) && count($stock) ) {
											foreach($stock as $loop){
												$date1= date('d-m-Y', strtotime($loop['pdate']));
												$date2 = date("Y-m-d");
												
												//date_create(date('d-m-Y'));
												$date3 = $loop['credit_days'];
												$totdate = date('Y-m-d',strtotime($date1.' +'.$date3.' days'));
												...
												<tr>
												  ...
												  <td>
                                                  <?php if($date2 > $totdate){?>
                                                  
                                                  <a class="btn" style="color:red;" href="<?php echo base_url('index.php/Vendor/makepayment?id='.urlencode($loop['vinvno'])); ?>" ><button type="button" class="btn btn-danger btn-xs" data-original-title="Payment">Make A Payment </button></a>
                                                  <?php }
												   else {?>
                                                  
                                                  <a class="btn" style="color:red;" href="<?php echo base_url('index.php/Vendor/makepayment?id='.urlencode($loop['vinvno'])); ?>" ><button type="button" class="btn btn-success btn-xs" data-original-title="Payment">Make A Payment </button></a>
                                                  <?php }?>
                                                </td>
