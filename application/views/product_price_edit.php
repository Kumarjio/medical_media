     ...
     <!-- PAGE TITLE -->
                ...
                <div class="row">
                        ...
                        <div class="panel panel-default">
                                ...
                                <h3 class="pull-left">Edit Vendor Product Rate</h3>
                            <form class="form-horizontal" id="jvalidate" role="form" action="<?php echo base_url();?>index.php/PriceList/editprice/<?php echo $pricelist[0]['id']  ?>" method="post">
...
<div class="form-group">
        ...
        <div class="col-md-8">
            <select class="selectpicker form-control "    name="vname" id="vname" required data-live-search="true" data-live-search-placeholder="Search" data-actions-box="true">
                                    <option value="<?php echo $pricelist[0]['vendor_id'] ?>"  selected><?php echo $pricelist[0]['vendor_name'] ?></option>
    ...
    <div class="form-group " >                                        
       ...
       <div class="col-md-8 " >
                <select class="selectpicker form-control"     name="pname1" id="pname1"  data-live-search="true" data-live-search-placeholder="Search" data-actions-box="true">
                          <option value="<?php echo $pricelist[0]['i_id'] ?>" selected><?php echo $pricelist[0]['i_name'];echo "-";echo $pricelist[0]['manu_name'];echo "-";echo $pricelist[0]['hsn_code']; ?></option>        
    ...
    <div class="form-group">                                        
        ...
        <div class="col-md-8">
                <input type="text" required class="form-control " style="color:#000;"   placeholder="Enter Product Rate" name="price" value="<?php echo $pricelist[0]['price'] ?>" id="price" >
